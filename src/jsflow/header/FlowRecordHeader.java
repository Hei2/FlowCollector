...
public class FlowRecordHeader {
	...
	public final static int RAW_PACKET_HEADER = 1;
	public final static int ETHERNET_FRAME = 2;
	public final static int IPV4_DATA = 3;
	public final static int IPV6_DATA = 4;
	public final static int EXTENDED_SWITCH = 1001;
	public final static int EXTENDED_ROUTER = 1002;
	public final static int EXTENDED_GATEWAY = 1003;
	public final static int EXTENDED_USER = 1004;
	public final static int EXTENDED_URL = 1005;
	public final static int EXTENDED_MPLS = 1006;
	...
	public static FlowRecordHeader parse(byte[] data) throws HeaderParseException, UtilityException  {
			...
			if(frd.getFlowDataFormat() == RAW_PACKET_HEADER){
				// raw packet header
	...
	public String toString(){
		...
		if(this.getFlowDataFormat() == 1){
			retVal += this.getRawPacketHeader();
		}
		return retVal;
	}
}
