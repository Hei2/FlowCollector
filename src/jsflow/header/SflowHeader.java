...
/**
 * 
 * Information about the sFlow datagram specification can be found at:
 * http://www.sflow.org/developers/specifications.php
 * 
 * @author Wei Kang Lim <weikang.lim@ndsu.edu>
 *
 */
public class SflowHeader {
	...
	public static SflowHeader parse(byte[] data) throws HeaderParseException, HeaderException, UtilityException {
