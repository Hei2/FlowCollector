...
public class RawPacketHeader {
	...
	public static RawPacketHeader parse(byte[] data) throws HeaderParseException, UtilityException  {
		...
		if (rp.getHeaderProtocol() == ETHERNET_ISO88023) {
			...
			System.err.println("Sample data format for raw packet header not yet supported: " + rp.getHeaderProtocol());
		}
